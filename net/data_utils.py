...
from metrics import *  # metrics.py
from option import opt   # option.py
BS=opt.bs
print(BS)
crop_size='whole_img'
if opt.crop:
...
path = r'G:\dataset\indoor-training-set-its-residestandard'
its_train_path = r'G:\dataset\indoor-training-set-its-residestandard'
its_test_path = r'G:\dataset\synthetic-objective-testing-set-sots-reside\indoor'
ots_train_path = r'G:\dataset\indoor-training-set-its-residestandard'
ots_test_path = r'G:\dataset\synthetic-objective-testing-set-sots-reside\outdoor'
